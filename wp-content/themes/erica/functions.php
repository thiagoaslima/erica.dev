...
if (function_exists('add_theme_support'))
{
    ...
    add_image_size('erica_view', 736, 469, true); // Custom Thumbnail Size call using the_post_thumbnail('custom-size');
...
function html5blank_styles()
{
    ...
    wp_register_style('html5boilerplate', get_template_directory_uri() . '/css/base.css', array(), '1.0', 'all');
    wp_enqueue_style('html5boilerplate'); // Enqueue it!

    if ( !is_home() ){
        wp_register_style('erica', get_template_directory_uri() . '/style.css', array(), '1.0', 'all');
        wp_enqueue_style('erica'); // Enqueue it!
    }
